...
<script lang="ts">
import { asyncRule, maxLength, required } from '@/utils/rules'
import { defineComponent, ref, computed } from 'vue'
import Form from '@/components/FormV2.vue'
import Button from '@/components/Button.vue'
import InputField from '@/components/InputFieldV2.vue'
...
export default defineComponent({
  ...
  setup() {
    ...
    const rules = {
      username: [required, maxLength(8), asyncRule],
