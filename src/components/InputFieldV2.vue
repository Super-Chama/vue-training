...
<script lang="ts">
import { ref, computed, defineComponent, inject, type Ref } from 'vue'
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const formContext = inject<Ref<Record<string, string[]>>>('formContext')!
    ...
    window.addEventListener('submit', () => {
      ...
      formContext.value['errors'].push(isValid)
